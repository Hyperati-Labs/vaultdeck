...
export default function SettingsScreen() {
  ...
  const [importWarningAcknowledged, setImportWarningAcknowledged] =
    useState(false);
  ...
  const isBackupActionValid =
    backupAction === "export"
      ...
      : isImportPassphraseValid && importWarningAcknowledged;
          ...
          <View style={styles.modalCard}>
            ...
            {backupAction === "import" ? (
              <View style={styles.warningBox}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    setImportWarningAcknowledged(!importWarningAcknowledged)
                  }
                  activeOpacity={0.7}
                >
            ...
            >
              <TextInput
                ...
                secureTextEntry
                editable={
                  backupAction === "export" || importWarningAcknowledged
                }
                style={[
                  styles.input,
                  backupAction === "import" &&
